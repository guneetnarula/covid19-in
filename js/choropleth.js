      ...
      function createElements(){
        ...
        $legend.appendTo('#legend');
				...
				$('#abt-modal').click( function () {
					...
					$(".modal-body").empty().append('<p>This map is an attempt at tracking CoVid-19 cases in India at the district level. The source of this data is news reports, and the official <a href="http://www.mohfw.gov.in/" target="_blank">numbers from MoHFW</a> are used as a reference. The <a href="https://docs.google.com/spreadsheets/d/e/2PACX-1vRlSCAn1nS4h9n9Fp25iuOsH54RfMUjj3xX5CZqjGUqYCVXgwgtJojuqVeqekazs2TkSJ95Jwplo7lL/pubhtml#" target="_blank">data is compiled here</a>.</p><p>Some issues regarding this exercise: a) should the cases be marked where the patient is currently quarantined or where they reside (or where spread may have happened), b) the time at which a news report is published sometimes is not when the actual cases were reported by authorities, this may be a cause of discrepancies</p><hr><p>If you need help or more information about the pandemic, consider the following links:</p><ul><li><a href="https://www.who.int/health-topics/coronavirus" target="_blank">World Health Organization</a></li><li><a href="http://www.mohfw.gov.in/" target="_blank">Ministry of Health and Family Welfare</a></li><li><a href="https://ourworldindata.org/coronavirus" target="_blank">Our World in Data</a></li><li><a href="https://www.coronasafe.in/" target="_blank">Coronasafe</a></li><li><a href="https://www.covidout.in/" target="_blank">COVID19 Outbreak in India (by Kiprosh)</a></li></ul>');
				});
